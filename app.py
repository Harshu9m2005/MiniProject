...
def train_yolov8():
    ...
    results = model.train(
        data='C:\Users\VM MANIKANDAN\Downloads\HARSHU 2\HARSHU 2\data.yaml',  # Your YAML file path
    ...
    weights_path = f"C:\Users\VM MANIKANDAN\Downloads\HARSHU 2\HARSHU 2\runs\train\harshu_yolov8\weights\best.pt"
    ...
    model.save('C:/Users/somes/Desktop/HARSHU 2/harshu_yolov8_final.pt')
